      ...
      projects: [
        {
          ...
          links: {
            ...
            download:
              "https://github.com/ArchieDev242/arcanoid_js/archive/refs/heads/main.zip",
          },
          features: [
          ...
          coursework:
            "Developed during IT-Start programming courses as a practical project to learn web technologies and game development fundamentals.",
          achievements: [
        ...
        },
        {
          ...
          description:
            "A 2D game developed using SDL2 library in pure C. This project demonstrates fundamental game development concepts including real-time rendering, input handling, and game state management using low-level C programming.",
          fullDescription:
            "SDL Game Project represents my exploration into native game development using pure C and the SDL2 library. This project showcases fundamental game development concepts including real-time 2D rendering, efficient input handling, and game state management. Built with clean C code, it demonstrates proficiency in low-level programming, memory management, and understanding of graphics programming without high-level abstractions.",
          image: "/projects/sdl-game-project/cover.webp",
          additionalImages: [
            "/projects/sdl-game-project/01.webp",
            "/projects/sdl-game-project/02.webp",
          ],
          ...
          license: "Open Source",
          links: {
            github: "https://github.com/ArchieDev242/The-Loop-Place",
            demo: "https://youtu.be/Ynthj9Q90OY?si=OSy8Tkw1dvTM4gYn",
            download: "https://github.com/ArchieDev242/The-Loop-Place/releases",
          },
          team: {
            name: "Floppa Team",
            members: [
            ...
            description:
              "Floppa Team is a passionate collective of Ukrainian game developers who came together during their computer science studies to create engaging 2D games using C and SDL2. The team emphasizes clean code architecture, cross-platform compatibility, and efficient performance optimization.",
          },
          features: [
          ...
          gameplay: {
            description:
              "Players control a character in a dynamic 2D environment, fighting against waves of enemies that become progressively more challenging. The game features fast-paced combat with visual feedback through particle effects and smooth animations.",
            mechanics: [
          ...
          instructions: {
            ...
            installation: [
              ...
              "Clone the repository: git clone https://github.com/ArchieDev242/The-Loop-Place.git",
              "Navigate to project directory: cd The-Loop-Place",
          ...
          projectStructure: {
            description:
              "Well-organized C project with modular design and clean architecture",
            directories: [
          ...
          gitCommands: {
            clone:
              "git clone https://github.com/ArchieDev242/The-Loop-Place.git",
            navigate: "cd The-Loop-Place",
            build: "make",
            run: "./endgame",
            clean: "make clean",
      ...
      projects: [
        {
          ...
          description:
            "A powerful Windows-only C++ utility that bridges the gap between FAT32's legacy 8.3 filenames and modern long filenames. This Windows-specific tool searches for files with short names and displays their full long names along with complete file paths.",
          fullDescription:
            "This Windows-exclusive C++ program was developed as a coursework project to demonstrate file system operations and Windows API usage. It specifically works with FAT32 file systems on Windows operating systems, which still use the legacy 8.3 naming convention alongside long filenames. The program provides an efficient way to locate files using their short names and retrieve their corresponding long filenames. Important: This code works only on Windows systems.",
          image: "/projects/short-to-long-filename/cover.webp",
          additionalImages: ["/projects/short-to-long-filename/01.webp"],
          technologies: [
            "C++",
            "Windows API",
            "FAT32",
          ...
          links: {
            ...
            download:
              "https://github.com/ArchieDev242/ShortToLongFilename/archive/refs/heads/main.zip",
          },
          features: [
          ...
          courseInfo:
            "Developed as a coursework project focusing on file system operations, Windows API programming, 8.3 filename conventions, and FAT32 file system characteristics.",
        },
      ],
    },
    {
      ...
      projects: [
        {
          ...
          description:
            "A simple and beginner-friendly Lua script tool for Friday Night Funkin' modders to easily add video cutscenes to their mods. This tool simplifies the process of integrating custom video content into Psych Engine-based FNF modifications.",
          fullDescription:
            "This is my first Lua script uploaded to GitHub and GameBanana. I believe that cutscenes are one of the main parts of FNF mods, and while experienced modders know how to write custom code, many people can't write code themselves. This tool provides a ready-to-use solution that you can download and implement in your mod without programming knowledge.",
          ...
          links: {
            ...
            alternativeSource:
              "https://github.com/Argonizer3500/FNF-Cutscene-Lua-script/blob/main/cutscene%20script",
          },
          features: [
          ...
          communityFeedback: {
            rating: "Positive",
            comments:
              "No comments yet, but good download statistics indicate community acceptance",
          },
        },
      ],
    },
      ...
      projects: [
        {
          ...
          description:
            "A modern, responsive web-based calculator built with vanilla JavaScript, HTML5, and CSS3. Features an intuitive interface with support for basic arithmetic operations, memory functions, unit conversions, and number system conversions. Developed as part of Ucode Marathon Race00 project.",
          fullDescription:
            "Ucode Calculator is a comprehensive web-based calculator application developed as part of the Race00 project for Ucode Marathon 2025. Built entirely with vanilla technologies (HTML5, CSS3, and JavaScript ES2015+), this project demonstrates modern web development practices, clean code architecture, and user-friendly interface design. The calculator supports all basic arithmetic operations, advanced mathematical functions, memory operations, unit conversions (length, area, weight), and number system conversions (decimal, binary, hexadecimal). Features include clipboard operations, keyboard shortcuts, calculation history, and a sleek macOS-inspired design with smooth animations.",
          image: "/projects/ucode-calculator/cover.webp",
          additionalImages: [],
          technologies: [
            "JavaScript",
            "HTML5",
          ...
          links: {
            ...
            download:
              "https://github.com/ArchieDev242/Ucode_Calculator/archive/refs/heads/main.zip",
          },
          features: [
          ...
          projectInfo:
            "Developed as part of Ucode Marathon Race00 project by a team of 2 developers. This project combined knowledge from five course sprints, demonstrating mastery of HTML5, CSS3, JavaScript ES2015+, DOM manipulation, and Git version control.",
          teamInfo: {
            teamSize: "2 developers",
            ...
            collaboration:
              "Collaborative development with clearly defined roles - Maksym as Team Lead handling project coordination and core logic, Volodymyr as Main Developer focusing on implementation and design",
          },
          achievements: [
        ...
        },
        {
          ...
          links: {
            ...
            download:
              "https://github.com/ArchieDev242/IT-Start_course_sites/archive/refs/heads/main.zip",
          },
          features: [
          ...
          projectInfo:
            "Developed during the IT-Start Evolution web development course, this portfolio represents my journey learning modern web technologies. Each project demonstrates different aspects of web development, from basic HTML/CSS to advanced JavaScript interactions and responsive design principles.",
          achievements: [
...
export {
  ...
  get_all_projects as getAllProjects,
  get_project_by_slug as getProjectBySlug,
};
