...
const SkillTree = () => {
  ...
  const [unlocked_skills, set_unlocked_skills] = useState([
    "html",
    "css",
    "js",
    "react",
  ...
  const timeline_events = [
    ...
    },
    {
      ...
      description:
        "Started offline IT courses: Web Development (HTML, CSS, JavaScript, Angular, React, Vue.js, TypeScript), 3D design (Cinema 4D), UI/UX design (Figma, Photoshop)",
      x: 320,
      y: 950,
      color: "#38bdf8",
    },
    ...
    },
    {
      ...
      description:
        "Started learning Game Development and Unity in IT-Start Evolution courses",
      x: 720,
      y: 950,
      color: "#e879f9",
    },
    {
      ...
      description:
        "Full-scale war began in Ukraine. Everything split into 'before' and 'after' this moment. Despite everything, continued learning and growing.",
      x: 920,
      y: 950,
      color: "#dc2626",
    },
    {
      ...
      description:
        "Completed my journey as a Friday Night Funkin' (FNF) mod maker and started learning Unreal Engine with C/C++. Also entered university to further my education.",
      x: 1120,
      y: 950,
      color: "#4ade80",
    },
  ...
  const skills_data = {
    root: {
      ...
      x: 500,
      y: 400,
      description: "Your core development abilities",
    },
    ...
    skills: [
      ...
      },
      {
        ...
        y: 280,
        description:
          "Explored Java development in the past, but no longer actively using (2019)",
        points: 2,
      ...
      },
      {
        ...
        y: 620,
        description:
          "Object-oriented programming for Unity game development (2023)",
        points: 1,
        connections: ["lua_game"],
        category: "Game Development",
        skillLevel: "Basic",
      ...
      },
      {
        ...
        y: 760,
        description:
          "Simple and easy-to-use library for game programming (2024)",
        points: 2,
        connections: ["cpp_game"],
        category: "Game Development",
        skillLevel: "Beginner",
      ...
      // ===== LEGACY SKILLS BRANCH =====
      {
        ...
        y: 620,
        description:
          "Object-oriented programming language (explored in the past)",
        points: 0,
        connections: ["root"],
      ...
      },
      {
        ...
        y: 750,
        description:
          "Structured programming language, great for learning fundamentals",
        points: 0,
        connections: ["root"],
        category: "Legacy Skills",
        skillLevel: "Basic",
  ...
  const handle_node_drag_start = (skill, e) => {
    ...
    const rect = e.currentTarget.getBoundingClientRect();
    const container_rect = e.currentTarget
      .closest(".skill-tree-container")
  ...
  const handle_node_drag = (e) => {
    ...
    const container_rect = document
      .querySelector(".skill-tree-container")
      .getBoundingClientRect();
      ...
      >
        ...
        >
          ...
          {skills_data.skills.map((skill) =>
            skill.connections.map((connId, idx) => {
              ...
              const path = generate_branch_path(
                start_node.x + 8,
                start_node.y + 8,
                end_node.x + 8,
                end_node.y + 8,
              ...
              const glow_color = category_color
                .replace("rgb(", "rgba(")
                .replace(")", ", 0.4)");
          ...
          {skills_data.skills.map((skill) =>
            skill.connections.map((connId, idx) => {
              ...
              const category_color = get_category_color(end_node.category);
              const line_color = category_color
                .replace("rgb(", "rgba(")
                .replace(")", ", 0.5)");
        ...
        <AnimatePresence>
          {active_skill && (
            ...
            >
              <SkillDetails skill={active_skill} position={popup_position} />
            </div>
          )}
        </AnimatePresence>
      </div>
