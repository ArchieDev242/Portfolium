    ...
    <motion.div
      ...
      style={{
        ...
        y: useTransform(
          scrollYProgress,
          [0, 1],
          [y.get(), y.get() + parallax_offset.get()],
        ),
      }}
      whileHover={{
        scale: 1.15,
    ...
    >
      ...
      >
        <div className="text-center z-10">
          <div
            className={`${tier_style.fontSize} font-bold text-white mb-0.5 leading-tight`}
          >
            {skill.title}
          </div>
          <div
            className={`${tier_style.levelFontSize} font-semibold`}
      ...
      {isActive && (
        <motion.div
          ...
          style={{
            borderColor: skill.color,
            boxShadow: `0 15px 35px ${skill.color}25`,
          }}
        >
          <div
...
const SkillsParallaxNew = () => {
  ...
  const skills = [
    ...
    // Expert Level
    {
      ...
      description:
        "Master-level ES6+ development, async programming, and architecture",
      skillLevel: "Expert",
    },
    {
      id: "html",
  ...
  const connection_objects = connections
    .map((conn, index) => {
