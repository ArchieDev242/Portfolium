      ...
      >
            ...
            {projectsData.categories.map((category, index) => (
              <li
                ...
                style = {{
                  ...
                  padding: "4px 12px",
                  background:
                    selected_category === index ? "#c0c0c0" : "#f0f0f0",
                  border: "1px solid #808080",
                  borderBottom:
                    selected_category === index ? "none" : "1px solid #808080",
                  borderTop:
                    selected_category === index ? "1px solid #808080" : "none",
                  marginRight: "2px",
                  cursor: "pointer",
                }}
              >
        ...
        >
          <fieldset style = {{ marginBottom: "15px" }}>
            ...
            <div
              style = {{ padding: "10px", fontSize: "11px", fontStyle: "italic" }}
            >
          ...
          >
            {projectsData.categories[selected_category].projects.map(
              (project, index) => (
                <div
                  key = {index}
                  className = "sunken-panel"
                ...
                >
                  ...
                  {project.features && (
                    <fieldset style = {{ marginBottom: "10px" }}>
                      <legend style = {{ fontSize: "10px", fontWeight: "bold" }}>
                        Features
                      </legend>
                  ...
                  >
                    {project.links?.playGame && (
                      <button
                        onClick = {() =>
                          window.open(project.links.playGame, "_blank")
                        }
                        style = {{
                          fontSize: "10px",
                          padding: "2px 8px",
                    ...
                    {project.links?.gamebanana && (
                      <button
                        onClick = {() =>
                          window.open(project.links.gamebanana, "_blank")
                        }
                        style = {{
                          fontSize: "10px",
                          padding: "2px 8px",
            ...
            >
              <Image
                ...
                onError = {(e) => {
                  ...
                  e.target.insertAdjacentHTML(
                    "afterend",
                    '<span style="font-size: 32px; margin-bottom: 10px;">ℹ️</span>',
                  );
                }}
              />
              <br />
        ...
        <div className = "status-bar" style = {{ marginTop: "10px" }}>
          <div className = "status-bar-field">
            {projectsData.categories[selected_category].projects.length}{" "}
            project(s) in {projectsData.categories[selected_category].name}
          </div>
