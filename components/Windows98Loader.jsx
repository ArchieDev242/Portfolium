...
const Windows98Loader = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    link_overlay.id = 'win98-loader-custom-css';
    ...
    if(typeof window !== 'undefined') 
      ...
      return () => {
        ...
        const el_98 = document.getElementById('win98-loader-98css');
        if(el_98) document.head.removeChild(el_98);
        const el_overlay = document.getElementById('win98-loader-custom-css');
